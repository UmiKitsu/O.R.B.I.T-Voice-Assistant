...
Orbit resolves only these fixed filenames. It never accepts an executable, model, or output path from the renderer, the user, or the AI model. Packaged builds copy this directory to the application's resources.
